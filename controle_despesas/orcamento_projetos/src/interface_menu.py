...
class InterfaceMenu:
    ...
    def if_add_materiais(self):
        ...
        quantidade = int(input("Informe a quantidade quantidade do material: "))
        ...
        add_material = self.pj_controller.pc_cadastrar_materiais(ID, nome, valor, quantidade, unidade_medida, qntd_usado)
    ...
    def if_listar_materiais(self):
        ...
        for material in mt:
            ...
            print(f"Quantidade: {material['quantidade_material']}/{material['unidade_medida']}")  
            print(f"Qntd material usado: {material['qntd_material_usado']}/{material['unidade_medida']}")
