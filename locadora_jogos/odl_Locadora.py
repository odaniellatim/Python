from locadora_jogos.base_dados import *
...
class Locadora:
    ...
    def jogo_por_plataforma(self, *plataformas_desejadas):
    ...
    def menu_principal(self):
        ...
        while encerrar_programa:
            ...
            match item_selecionado:
                case 0:
                    plataformas_desejadas = input("Quer informar os consoles que deseja filtrar. ")
                    self.jogo_por_plataforma(plataformas_desejadas)
                case 1:
                    for id, console in enumerate(consoles_db):
                        print(f"{id}. {console}")
                        
                    console_selecionado = input("Informe o ID do console. ")
                    self.listar_consoles_cadatrados(console_selecionado)
                case _:
